<div class="row">
	<div class="updateBox">
		...
		<div class="box-container">
			<form name="update_contacts" id="update_contacts" method="POST">
...
<!--===============-->
		        ...
		        <div class="input-field col s12 m12">
		        	<input type="button" name="updateData" value="Save" class="btn btn-flat btn-save">
		        </div>
  ...
  $(".btn-save").on("click",function()
	{
		...
		/*alert("ok");*/
		var updriverform = new FormData($("#update_contacts")[0]);
        $.ajax({
	          url : baseurl+"ContactList/updateContactList/",
	          data : updriverform,
	          type:"POST",
	          contentType:false,
	          processData:false,
